...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "telega-filter" '("all" "any" "archive" "can-get-statistics" "chat-list" "contact" "custom" "default-disable-notification" "define-telega-filter" "folder" "has-" "ids" "inactive-supergroups" "last-message-by-me" "main" "my-permission" "name" "nearby" "not" "online-status" "permission" "pin" "replies-messages" "restriction" "saved-messages" "search" "top" "tracking" "type" "unmuted" "unread" "verified")))
